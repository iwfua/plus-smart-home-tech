...
public class AggregatorStarter {
    ...
    public AggregatorStarter(KafkaConfig kafka, KafkaConsumer<String, SensorEventAvro> kafkaConsumer, KafkaProducer<String, SpecificRecordBase> kafkaProducer, AggregatorService aggregatorService) {
